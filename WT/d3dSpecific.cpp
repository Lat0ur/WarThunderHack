...
bool InitD3DHook(IDXGISwapChain* pSwapchain)
{
	...
	Vertex pVerts[3] = {
		{ XMFLOAT3(left + fPosX/10,			top - fPosY/10 + h / 2,	1.0f),	XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ XMFLOAT3(left + fPosX/10 + w / 2,	top - fPosY/10 - h / 2,	1.0f),	XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) },
		{ XMFLOAT3(left + fPosX/10 - w / 2,	top - fPosY/10 - h / 2,	1.0f),	XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },
	};
...
bool installD3DHook() {
	...
	printf("D3D11CreateDeviceAndSwapChain success\r\n");
	// Get swapchain vmt
